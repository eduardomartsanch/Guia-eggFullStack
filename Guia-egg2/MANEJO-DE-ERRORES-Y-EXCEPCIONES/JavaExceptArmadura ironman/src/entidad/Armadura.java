...
public abstract class Armadura {
   protected Integer salud; // se mide de 0 a 100
   protected Integer resistencia;
   protected Integer energia; // energia de 10,000
   protected String Material;
   protected Integer consumoEnergetico;
   protected Integer tiempo;
    public Armadura() {
    }

    public Armadura(Integer salud, Integer resistencia, Integer energia, String Material, Integer consumoEnergetico, Integer tiempo) {
        this.salud = salud;
    ...
    public String toString() {
        return "Armadura{" + "salud=" + salud + ", resistencia=" + resistencia + ", energia=" + energia + ", Material=" + Material + ", consumoEnergetico=" + consumoEnergetico + ", tiempo=" + tiempo + '}';
    }
